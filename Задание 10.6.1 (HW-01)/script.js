...
const icon1 = `
  <svg id="icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-left-circle" viewBox="0 0 16 16">
...
const icon2 = `
  <svg id="icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-left-circle-fill" viewBox="0 0 16 16">
...
toggleButton.addEventListener('click', () => {
  if (isIcon1) {
    toggleButton.innerHTML = icon2; 
  } else {
    toggleButton.innerHTML = icon1; 
  }
  isIcon1 = !isIcon1; 
});